...
def fylker2023( myDf ):
    ...
    my_mapping= {   31 : 30, #  31 Østfold => 30 Viken
                    32 : 30, # 32 Akershus => 30 Viken
                    33 : 30, #      33 Buskerud => 30 Viken
                    39 : 38, # 39 Vestfold => 38 Vestfold og Telemark
                    40 : 40, # 40 Telemark => 38 Vestfold og Telemark
                    ...
                    56 : 54,  # 56 Finnmark => 54 Troms og Finnmark 
                    3 : 3,   # Oslo, uendret
                    11 : 11, # Rogaland, uendret
                    15 : 15, # Møre og Romsdal, uendret
                    18 : 18, # Nordland, uendret
                    34 : 34, # Innlandet, uendret
                    42 : 42, # Agder, uendret
                    46 : 46, # Vestlandet, uendret
                    50 : 50  # Trøndelag, uendret
                }
    
    myDf.rename(  columns= {'fylke' : 'fylke2024'}, inplace=True )
    myDf['fylke'] = myDf['fylke2024'].map( my_mapping ).fillna( -9999 )
    return myDf 
