...
veger = veger[ veger['d1'] <= datetime( 2023, 12, 31 ) ]
veger = veger[ veger['d2'] >  datetime( 2023, 12, 31 ) ]
...
skrivdataframe.skrivdf2xlsx( [telling2,             telling,               lengde], '../kostraleveranse2023/Kostra 20 - Midtrekkverk to og trefelts Fv.xlsx', 
