...
skrivdataframe.skrivdf2xlsx( lengde, '../kostraleveranse2023/Kostra 02 - Fylkesveg med motorveg og motortrafikkveg.xlsx', sheet_name='Fv med motor(trafikk)veg', metadata=mittfilter)
